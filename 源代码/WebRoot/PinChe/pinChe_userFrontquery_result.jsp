...
<jsp:include page="../header.jsp"></jsp:include>
	<div class="col-md-9 wow fadeInLeft">
		<ul class="breadcrumb">
  			...
  			<li><a href="<%=basePath %>PinChe/userFrontlist">我发布的拼车信息</a></li>
			...
			<div class="col-md-3 bottom15" <%=clearLeft %>>
			  <a  href="<%=basePath  %>PinChe/<%=pinChe.getPincheId() %>/frontshow"><img class="img-responsive" src="<%=basePath%><%=pinChe.getPinChePhoto()%>" /></a>
			     <div class="showFields">
			        ...
			        <a class="btn btn-primary top5" href="<%=basePath %>PinCheOrder/frontlist?pinCheObj.pincheId=<%=pinChe.getPincheId() %>">订单查看</a>
			     </div>
			</div>
			<%  } %>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="pinCheQueryForm" id="pinCheQueryForm" action="<%=basePath %>PinChe/userFrontlist" class="mar_t15">

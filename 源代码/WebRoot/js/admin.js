		       ...
		       text: "小车管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "CarInfo/carInfo_add.jsp"
			    	   	},
			    		{
			    	   		text: "小车管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "CarInfo/carInfo_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "拼车管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "PinChe/pinChe_add.jsp"
			    	   	},
			    		{
			    	   		text: "拼车管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "PinChe/pinChe_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "拼车订单管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "PinCheOrder/pinCheOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "拼车订单管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "PinCheOrder/pinCheOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
			       text: "系统管理",

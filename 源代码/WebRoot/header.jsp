    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>CarInfo/frontlist">小车查询</a></li>
                <li><a href="<%=basePath %>PinChe/frontlist">拼车信息</a></li>
               <!--  <li><a href="<%=basePath %>PinCheOrder/frontlist">拼车订单</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>CarInfo/carInfo_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;提交我的车子</a></li>
                        <li><a href="<%=basePath %>CarInfo/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我提交的车子</a></li>
                        <li><a href="<%=basePath %>PinChe/pinChe_userFrontAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布拼车信息</a></li>
                        <li><a href="<%=basePath %>PinChe/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的拼车信息</a></li>
                        <li><a href="<%=basePath %>PinCheOrder/userFrontlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的拼车订单</a></li>
                    	<li><a href="<%=basePath %>UserInfo/userInfo_selfModify.jsp"><span class="glyphicon glyphicon-edit "></span>&nbsp;&nbsp;修改个人信息</a></li>
                    </ul>
                </li>
